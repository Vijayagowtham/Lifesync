...
import { useLiveLocation } from '../../../hooks/ambulance/useLiveLocation';
import { cn } from '../../../lib/ambulance/utils';
import { motion, AnimatePresence } from 'motion/react';

export const LocationManager = ({ onLocationUpdate }) => {
        ...
        {status === 'idle' && (
          ...
          >
            <button
              ...
              className="w-full py-4 bg-red-500 text-white font-bold rounded-2xl flex items-center justify-center gap-2 shadow-lg shadow-red-200 hover:bg-red-600 transition-colors"
            >
