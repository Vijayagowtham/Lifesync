  ...
  return (
    ...
    >
      ...
      <div className="space-y-4">
        <div>
          <h3 className="text-lg font-bold text-slate-800">{ride.patient.name}</h3>
        ...
        <div className="flex flex-col gap-3 pt-4">
          ...
          <div className="flex gap-3">
            <button className="flex-1 bg-slate-800 text-white py-3 rounded-xl font-bold text-sm flex items-center justify-center gap-2 hover:bg-black transition-colors">
              <Phone className="w-4 h-4" />
              Call
            </button>
            <button 
              onClick={onComplete}
              className="flex-1 bg-red-500 text-white py-3 rounded-xl font-bold text-sm flex items-center justify-center gap-2 hover:bg-red-600 transition-colors shadow-lg shadow-red-200"
            >
